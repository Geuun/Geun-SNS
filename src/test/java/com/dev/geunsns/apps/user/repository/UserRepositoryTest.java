...
/**
 * DataJpaTest 어노테이션은 인메모리 DB(지원: H2, DERBY, HSQLDB)로 테스트
 * 물리적인 DB를 연결하기위해 AutoConfigureTestDatabase 어노테이션의 replace 옵션 사용)
 */
@DataJpaTest
...
class UserRepositoryTest {
	...
	void dataJpaAuditingTest() {
		...
		UserEntity testUser = new UserEntity(userName, password);
